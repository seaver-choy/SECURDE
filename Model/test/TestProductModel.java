...
public class TestProductModel{
    public static ArrayList<Product> getAllProducts(){
        ...
        try {
            ...
            Logger.getLogger(TestProductModel.class.getName()).log(Level.SEVERE, null, ex);
        } return objectList;
    }
    ...
    public static void updateProduct(int product_id, Product product){
        DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd-HH:mm:ss:SS");
        DateFormat idFormat = new SimpleDateFormat("yyyyMMdd_HH-mm-ss-SS");
        String datetime = dateFormat.format(new Date());
        String id = idFormat.format(new Date());
        ...
        Log log = new Log(id + "_ProdMngr", 2,
                          "Update Product",
                          "Updated product #" + product.getName() + "'s product details.", 
                          datetime);
        log.writeLog();
    }
    ...
    private static boolean checkIfExists(Product product){
        try {
            Connection conn = MySQLConnector.getConnection();
            PreparedStatement statement = null;
