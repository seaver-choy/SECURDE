...
public class ProductModel implements ProductDAO{
    ...
    public boolean addProduct(Product product){
        ...
        if(!checkIfExists(product)){
            try{
                Connection conn = MySQLConnector.getConnection();
                PreparedStatement statement = null;
                String query = "INSERT INTO kickaj.products(name, category, details, price) VALUES(?,?,?,?, ?);";
                ...
                statement.setString(5, product.getImg_name());
                statement.execute();
                conn.commit();
            } catch (SQLException ex) {
                Logger.getLogger(ProductModel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void updateProduct(int product_id, Product product){
        ...
        try{
            Connection conn = MySQLConnector.getConnection();
            PreparedStatement statement = null;
            String query = "UPDATE kickaj.products SET name = ?, category = ?, details = ?, price = ?, img_name = ? WHERE product_id = ?";
    ...
    public void deleteProduct(int product_id){
        ...
        try {
            Connection conn = MySQLConnector.getConnection();
            PreparedStatement statement = null;
            String query = "DELETE FROM kickaj.products WHERE product_id = ?;";
    ...
    private boolean checkIfExists(Product product){
        try {
            Connection conn = MySQLConnector.getConnection();
            PreparedStatement statement = null;
            String query = "SELECT * FROM kickaj.products WHERE name = ?;";
