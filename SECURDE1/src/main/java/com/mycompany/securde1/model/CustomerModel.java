...
public class CustomerModel implements CustomerDAO{
    ...
    public void updateCustomer(int customer_id, Account customer){
        ...
        try {
            ...
            String query = "UPDATE kickaj.accounts SET username = ?, password = ?, name = ?, email = ?, shipping_address = ?, billing_address = ? WHERE account_id = ?;";
    ...
    public ArrayList<Product> getAllProducts(){
        ...
        try {
            ...
            Connection conn = mySQLConnector.getConnection();
            PreparedStatement statement = null;
            String query = "SELECT * FROM kickaj.products;";
    ...
    public ArrayList<Review> getProductReviews(int product_id){
        ...
        try {
            ...
            Connection conn = mySQLConnector.getConnection();
            PreparedStatement statement = null;
            String query = "SELECT * FROM kickaj.reviews WHERE product_id = ?;";
    ...
    public Product getProduct(int product_id){
        ...
        try {
            ...
            Connection conn = mySQLConnector.getConnection();
            PreparedStatement statement = null;
            String query = "SELECT * FROM kickaj.products WHERE product_id = ?;";
    ...
    public boolean reviewProduct(Account customer, Product product, String title, String details){
        ...
        if(checkIfBought(customer, product)){
            try {
                ...
                Connection conn = mySQLConnector.getConnection();
                PreparedStatement statement = null;
                String query = "INSERT INTO kickaj.reviews(account_id, product_id, title, details, time_stamp) VALUES(?,?,?,?,?);";
    ...
    public boolean buyProduct(Account customer, Product product, int quantity, boolean validCredit){
        ...
        if(validCredit){
            try {
                ...
                Connection conn = mySQLConnector.getConnection();
                PreparedStatement statement = null;
                String query = "INSERT INTO kickaj.transactions(account_id, product_id, quantity, total_price, time_stamp) VALUES(?,?,?,?,?);";
    ...
    private static boolean checkIfBought(Account customer, Product product){
        try {
            ...
            Connection conn = mySQLConnector.getConnection();
            PreparedStatement statement = null;
            String query = "SELECT * FROM kickaj.transactions WHERE account_id = ? AND product_id = ?;";
